            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="text-center text-white">
                        ...
                        <div class="row">
                            <div class="col">
                                <input class="form-control form-control-lg" id="keyword" type="text" placeholder="NISN" name="keyword" onkeypress="return numberOnly(event)" required />
                            </div>
                        ...
                        if (session()->getFlashdata('alert')) {
                            echo '<center><div class="alert alert-danger alert-dismissible col-md-12 text-center ">';
