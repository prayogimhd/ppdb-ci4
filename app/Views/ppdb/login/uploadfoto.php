...
<div class="modal fade" id="modalupload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <br>
            <center>
                <img class="img-thumbnail" width="70%" src="<?= site_url('img/ppdb/'  . $list['foto_siswa']) ?>" alt="Foto Peserta PPDB">
            </center>
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="invalid-feedback errorFotosiswa">
...
<script>
    $(document).ready(function() {
        $('.btnupload').click(function(e) {
            ...
            $.ajax({
                type: "post",
                url: '<?= site_url('ppdb/douploadfoto') ?>',
                data: data,
                ...
                success: function(response) {
                    if (response.error) {
                        if (response.error.foto_siswa) {
                            ...
                            $('.errorFotosiswa').html(response.error.foto_siswa);
                        }
                    } else {
                        Swal.fire({
                            title: "Berhasil!",
