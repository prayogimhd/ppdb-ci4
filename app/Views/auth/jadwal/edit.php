...
<div class="modal fade" id="modaledit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <?= form_open('jadwal/updatejadwal', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <input type="hidden" class="form-control" id="id_jadwal" value="<?= $id_jadwal ?>" name="id_jadwal" readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" value="<?= $tanggal_ujian ?>" id="tanggal_ujian" name="tanggal_ujian">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" value="<?= $jam_ujian ?>" id="jam_ujian" name="jam_ujian">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?= $durasi_ujian ?>" id="durasi_ujian" name="durasi_ujian">
